/// A struct mapping from the readable name of a keycode (e.g. returnKey) to its UInt16 value
///
/// NB: Some keycodes are layout-independent and some are specific to certain keyboard types. Be careful about that (or fix it).
struct Keycode {
